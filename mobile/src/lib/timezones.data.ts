/**
 * Static Comprehensive List of Worldwide IANA Timezones
 */
export const timezones = [
    ...
    "America/Jujuy", "America/Juneau", "America/Knox_IN", "America/Kralendijk", "America/La_Paz", "America/Lima",
    ...
    "Europe/Astrakhan", "Europe/Athens", "Europe/Belfast", "Europe/Belgrade", "Europe/Berlin", "Europe/Bratislava",
    ...
    "Europe/Uzhgorod", "Europe/Vaduz", "Europe/Vatican", "Europe/Vienna", "Europe/Volgograd", "Europe/Warsaw",
    "Europe/Zagreb", "Europe/Zaporozhye", "Europe/Zurich", "GB", "GB-Eire", "GMT", "GMT+0", "GMT-0", "GMT0",
    ...
    "MST", "MST7MDT", "Mexico/BajaNorte", "Mexico/BajaSur", "Mexico/General", "NZ", "NZ-CHAT", "Navajo",
...
/**
 * Filtered UX-Friendly Timezones (Omits Legacy 'Etc/' system nodes and non-slashed shorthand codes)
 */
export const simplifiedTimezones = Array.from(
    new Set(timezones.filter(tz => tz.includes('/') && !tz.startsWith('Etc/')))
);